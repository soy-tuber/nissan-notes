...
**fable**　駆動モーターの最高出力は百五十一キロワット。第二世代から十一キロワット向上しています。そして第三世代の象徴が、ファイブ・イン・ワンと呼ばれる構成です。モーター、発電機、インバーター、減速機、増速機という五つの主要部品を、一つのコンパクトなケースに統合した。作っているのは日産本体ではなく、連結子会社のジヤトコです。静岡県富士市の「eパワートレイン工場」で、開発から生産まで一貫して手がけている。これによってユニット全体の剛性が上がり、振動や騒音が大幅に低減されました。部品を寄せ集めるのではなく、一体で設計する。これも、単純化の思想の延長にあります。
...
**fable**　はい。第三世代e-POWERは二〇二五年夏、欧州キャシュカイへの搭載で量産が始まりました。つまり、四十二パーセントもファイブ・イン・ワンも、すでに路上で実証されている。そして今、これからが水平展開の局面です。日本では二〇二六年六月に新型キックスが発表され、第三世代e-POWERを日本市場で初めて搭載しました。続いて七月に新型エルグランドが控えている。北米では、新型ローグに第三世代e-POWERを投入することを、日産自身が二〇二六年モデルの計画として公式に表明しています。そして二〇二六年九月には、欧州向けキックスを英サンダーランドで生産することが決まりました。一億七千万ポンドを投じる決定で、**第三世代e-POWERは欧州・日本・北米の三極すべてに載る**ことになります。
