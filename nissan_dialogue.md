...
**Opus**　そこが重要です。ジヤトコは日産の連結子会社ですから、連結の内側ではある。でも**工場の増強も、能力配分の判断も、本体の生産計画とは別の主体が持っている**。さらにジヤトコは、この電動ユニットを日産以外にも外販する方針を掲げています。つまり富士の枠は、日産の五車種だけでなく、**将来の外販とも取り合う**可能性がある。エルグランドの天井を「九州の枠」で説明してきましたが、その下にもう一段、**富士のユニット供給という天井**がある。日産の電動化戦略全体の制約条件は、ここです。
...
（二〇二六年九月十七日　5-in-1ユニットの生産拠点をジヤトコ富士に訂正）
